...
|------|------|------|
| 自动 | `auto` | 默认，服务端自选 |
| 像素 | `1024x1024`、`2560x1440` | 会规整为 16 倍数等合法范围 |
| 档位/比例 | `2k/16:9`、`1k/1:1`、`4k/9:16` | 展开为预设像素（**用 `/` 分隔**，不要写成 `2k:16:9`） |
| 仅档位 | `1k` / `2k` / `4k` | 等价于该档 `1:1` |

常用预设（完整表见 `references/api.md`）：

- `1k/1:1`→`1024x1024`，`1k/3:2`→`1536x1024`，`1k/16:9`→`1280x720`
- `2k/1:1`→`2048x2048`，`2k/16:9`→`2560x1440`，`2k/4:3`→`2048x1536`
